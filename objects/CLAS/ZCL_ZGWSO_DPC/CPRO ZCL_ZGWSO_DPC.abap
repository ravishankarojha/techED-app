protected section.
  ...
  methods SALESORDERITEMSE_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZGWSO_MPC=>TS_SALESORDERITEM
    raising
  ...
  methods SALESORDERITEMSE_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGWSO_MPC=>TT_SALESORDERITEM
  ...
  methods SALESORDERSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGWSO_MPC=>TS_SALESORDER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SALESORDERSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGWSO_MPC=>TT_SALESORDER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
