...
*&-----------------------------------------------------------------------------------------------*
 DATA i_draftadministr_get_entityset TYPE zcl_zcn_vdm_customer_c_mpc=>tt_i_draftadministrativedataty.
 DATA zcn_c_customerco_get_entityset TYPE zcl_zcn_vdm_customer_c_mpc=>tt_zcn_c_customercontacttype.
...
*     Call the entity set generated method
      zcn_c_customerco_get_entityset(
        EXPORTING
         iv_entity_name = iv_entity_name
         iv_entity_set_name = iv_entity_set_name
         iv_source_name = iv_source_name
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = zcn_c_customerco_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = zcn_c_customerco_get_entityset
        CHANGING
          cr_data = er_entityset
      ).
